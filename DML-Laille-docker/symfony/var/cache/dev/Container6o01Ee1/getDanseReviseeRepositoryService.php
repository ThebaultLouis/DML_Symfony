...
// Returns the private 'App\Repository\DanseReviseeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DanseReviseeRepository.php';

return $this->privates['App\Repository\DanseReviseeRepository'] = new \App\Repository\DanseReviseeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
