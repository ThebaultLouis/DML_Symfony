...
return $this->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('admin' => array('password' => 'admin', 'roles' => array(0 => 'ROLE_ADMIN'))));
