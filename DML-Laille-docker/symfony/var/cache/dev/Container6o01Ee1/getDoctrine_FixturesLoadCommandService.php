...
include_once $this->targetDirs[3].'/src/DataFixtures/DanseFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/ManifestationsFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures(array(0 => new \App\DataFixtures\AppFixtures(), 1 => new \App\DataFixtures\DanseFixtures(), 2 => new \App\DataFixtures\ManifestationsFixtures()));
