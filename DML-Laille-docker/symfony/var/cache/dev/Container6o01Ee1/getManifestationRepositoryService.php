...
// Returns the private 'App\Repository\ManifestationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ManifestationRepository.php';

return $this->privates['App\Repository\ManifestationRepository'] = new \App\Repository\ManifestationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
