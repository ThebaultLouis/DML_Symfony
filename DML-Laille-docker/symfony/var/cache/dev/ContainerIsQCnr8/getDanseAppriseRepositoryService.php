...
// Returns the private 'App\Repository\DanseAppriseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DanseAppriseRepository.php';

return $this->privates['App\Repository\DanseAppriseRepository'] = new \App\Repository\DanseAppriseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
