...
// Returns the private 'App\Repository\CoursSupplementaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CoursSupplementaireRepository.php';

return $this->privates['App\Repository\CoursSupplementaireRepository'] = new \App\Repository\CoursSupplementaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
