...
// Returns the private 'App\Repository\NiveauRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NiveauRepository.php';

return $this->privates['App\Repository\NiveauRepository'] = new \App\Repository\NiveauRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
